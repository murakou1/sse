...
public class Sample3AuthConfiguration {
  ...
  public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
    http.formLogin(login -> login
        ...
        .authorizeHttpRequests(authz -> authz
            ...
            .authenticated() // /sample5/以下は認証済みであること
  ...
  public InMemoryUserDetailsManager userDetailsService() {
    ...
    UserDetails customer1 = User.withUsername("customer1")
        .password("{bcrypt}$2y$10$OBD2V11/Z7t6KkwrG69rwOtNUaRlYMoXkM5NkpduNsRIrOIyGt43i")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 customer2 p@ss
    UserDetails customer2 = User.withUsername("customer2")
        .password("{bcrypt}$2y$10$f.nYiD2ZK4kSZyEOfQqwkegwgSQtlrAIjwpAq17PVhups6oDAN6O2")
        .roles("CUSTOMER")
        .build();
    // $ sshrun htpasswd -nbBC 10 seller p@ss
    UserDetails seller = User.withUsername("seller")
        .password("{bcrypt}$2y$10$/sx.4odthryadqH6XW/Eaez86XcqD2Bi0AOuo5.A9yKESg.CqjcLi")
        .roles("SELLER")
        .build();
